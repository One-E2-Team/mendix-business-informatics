...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.DocumentAccountStatusReport", mendixObject.getType()))
			return businessbankmodule.proxies.DocumentAccountStatusReport.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.DocumentBankAccountsReport", mendixObject.getType()))
			return businessbankmodule.proxies.DocumentBankAccountsReport.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.DocumentBankBillingAccountStatusReport", mendixObject.getType()))
			return businessbankmodule.proxies.DocumentBankBillingAccountStatusReport.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.DocumentPaymentOrder", mendixObject.getType()))
