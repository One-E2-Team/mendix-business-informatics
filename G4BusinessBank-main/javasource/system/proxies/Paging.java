...
public class Paging
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.Account_NewEdit_DataGrid", mendixObject.getType()))
			return businessbankmodule.proxies.Account_NewEdit_DataGrid.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("BusinessBankModule.TransferToAccountsPage_DataGrid", mendixObject.getType()))
