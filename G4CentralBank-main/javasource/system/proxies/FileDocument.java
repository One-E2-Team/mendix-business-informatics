...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("CentralBankModule.DocumentAccountsStateByDayReport", mendixObject.getType()))
			return centralbankmodule.proxies.DocumentAccountsStateByDayReport.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CentralBankModule.DocumentBankBillingAccountStatusReport", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("CentralBankModule.XMLDocument", mendixObject.getType()))
